package jp.co.alc.booco.core.ui.component
...
fun OutlinedButton(
    ...
    jp.co.alc.booco.core.ui.component.OutlinedButton(
        onClick = onClick,
        modifier = modifier,
        enabled = enabled,
        contentPadding = if (leadingIcon != null) {
...
fun TextButton(
    ...
    jp.co.alc.booco.core.ui.component.TextButton(
        onClick = onClick,
        modifier = modifier,
        enabled = enabled,
    ) {
...
fun ButtonPreview() {
    Surface {
        SolidButton(onClick = {}, text = { Text("Test button") })
    }
}